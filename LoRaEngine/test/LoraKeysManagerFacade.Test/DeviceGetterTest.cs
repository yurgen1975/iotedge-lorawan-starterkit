...
namespace LoraKeysManagerFacade.Test
{
    ...
    public class DeviceGetterTest
    {
        ...
        [Fact]
        public async Task Version_2018_12_16_Preview_Returns_Bad_Request_If_Version_2019_02_12_Preview_Is_Requested()
        {
            var request = new DefaultHttpRequest(new DefaultHttpContext())
            {
                Query = new QueryCollection(new Dictionary<string, Microsoft.Extensions.Primitives.StringValues>
                {
                    { ApiVersion.QueryStringParamName, ApiVersion.Version_2019_02_12_Preview.Version }
                }),
            };
            ...
            Assert.Equal("Incompatible versions (requested: '2019-02-12-preview', current: '2018-12-16-preview')", badRequestResult.Value.ToString());
