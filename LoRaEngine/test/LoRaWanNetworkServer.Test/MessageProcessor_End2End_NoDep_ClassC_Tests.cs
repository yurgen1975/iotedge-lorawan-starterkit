...
namespace LoRaWan.NetworkServer.Test
{
    ...
    public class MessageProcessor_End2End_NoDep_ClassC_Tests : MessageProcessorTestBase
    {
        ...
        public async Task When_ABP_Sends_Upstream_And_DirectMethod_Should_Send_Upstream_And_Downstream(string deviceGatewayID)
        {
            var simDevice = new SimulatedDevice(TestDeviceInfo.CreateABPDevice(1, gatewayID: deviceGatewayID, deviceClassType: 'c'));
        ...
        [Fact]
        public async Task Unconfirmed_Cloud_To_Device_From_Decoder_Should_Send_Downstream_Message_To_Class_C_Device()
        {
